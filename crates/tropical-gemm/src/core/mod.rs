...
pub use gemm::{
    tropical_gemm_inner, tropical_gemm_inner_with_workspace, tropical_gemm_portable,
    tropical_gemm_with_argmax_inner, tropical_gemm_with_argmax_inner_with_workspace,
