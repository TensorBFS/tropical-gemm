...
// Public API
pub use api::{
    tropical_gemm, tropical_matmul, tropical_matmul_batched, tropical_matmul_batched_with_argmax,
    tropical_matmul_strided_batched, tropical_matmul_with_argmax, TropicalGemm,
};
...
pub mod prelude {
    pub use super::{
        tropical_matmul, tropical_matmul_batched, tropical_matmul_batched_with_argmax,
        tropical_matmul_strided_batched, tropical_matmul_with_argmax, AndOr, Backend,
        CountingTropical, GemmWithArgmax, Mat, MatMut, MatRef, MatWithArgmax, MaxMul, MaxPlus,
        MinPlus, Transpose, TropicalAndOr, TropicalGemm, TropicalMaxMul, TropicalMaxPlus,
        TropicalMinPlus, TropicalSemiring, TropicalWithArgmax,
    };
}
